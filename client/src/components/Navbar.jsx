    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
                    ...
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                        ...
                        <path clipRule="evenodd"
                              ...
                              stroke="#7A7B7D" strokeWidth="1.2" strokeLinecap="round"
                ...
                <div className="relative cursor-pointer">
                    <svg width="18" height="18" viewBox="0 0 14 14" fill="none"
                        ...
                        <path
                            ...
                            stroke="#615fff" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                    <button
                ...
                <button
                    className="cursor-pointer px-8 py-2 bg-primary-dull hover:bg-indigo-600 transition text-white rounded-full">
                    Login
                </button>
            </div>
